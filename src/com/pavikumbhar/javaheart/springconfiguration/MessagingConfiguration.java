...
public class MessagingConfiguration {
	...
	@Bean
	public JmsTemplate jmsTemplateForQueueOne() {
		JmsTemplate jmsTemplate = new JmsTemplate();
		jmsTemplate.setConnectionFactory(connectionFactory());
		jmsTemplate.setDefaultDestination((Destination) destinationOne().getObject());
  ...
  public DefaultMessageListenerContainer queueMessageListener() {
	    ...
	    defaultMessageListenerContainer.setDestination((Destination) destinationTwo().getObject());
